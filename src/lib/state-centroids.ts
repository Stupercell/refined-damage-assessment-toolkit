// Approximate geographic centroids for US states (lat, lon).
// Used for placing static state labels on the map.
export const US_STATE_CENTROIDS: { code: string; name: string; lat: number; lon: number }[] = [
